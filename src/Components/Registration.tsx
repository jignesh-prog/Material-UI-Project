    ...
    <Box className='parent1' sx={{
      ...
      <Paper sx={{ border: 'dark', padding: '0 20px' }}>
        <Box sx={{ paddingLeft: '30px' }}>
          ...
          <Stack direction='row' spacing={2} sx={{ margin: '25px 0' }}>
            <FormControlLabel control={<Checkbox />} label='' sx={{ marginBottom: "90px" }} />
            <Typography variant='subtitle2' color="error" sx={{ textAlign: 'left', margin: '25px 0' }}>
          ...
          <Stack direction='row' spacing={2} sx={{ justifyContent: 'space-between', margin: '20px 0', textAlign: 'center', borderRadius: ' 10PX' }} >
            <Button sx={{ margin: '10px', textAlign: 'center', bgcolor: 'black', color: 'white' }}>Email  Request</Button>
            <Button sx={{ margin: '10px', textAlign: 'center', bgcolor: 'black', color: 'white' }}>Request to book</Button>
            <Button sx={{ margin: '10px', textAlign: 'center', bgcolor: 'black', color: 'white' }}>Request to Pay</Button>
          </Stack>
        </Box>
      </Paper>
    </Box>
